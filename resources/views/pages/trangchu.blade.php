			...
			<div class="main-content">
				...
				<div class="row">
					<div class="col-sm-12">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$new->id)}}" title="Chi tiết sản phẩm" target="blank"><img height="250px" src="source/image/product/{{$new->image}}" alt=""></a>
										</div>
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('themgiohang',$new->id)}}" title="Thêm sản phẩm vào giỏ hàng"><i class="fa fa-shopping-cart"></i></a>
						...
						<div class="new">{{$new_product->links()}}</div>
						<!-- phân trang -->
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								@if($spkm->status != 2)
								<div class="col-sm-3">
									<div style="margin-top:30px" class="single-item">
										<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$spkm->id)}}" target="blank"><img height="250px" src="source/image/product/{{$spkm->image}}" alt=""></a>
										</div>
										<div class="single-item-body">
						...
						<div class="new">{{$sanpham_khuyenmai->links()}}</div>
						<!-- phân trang -->
