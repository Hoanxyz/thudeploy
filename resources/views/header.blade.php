<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a><i class="fa fa-home"></i> Đại học Bách khoa Hà Nội</a></li>
						<li><a><i class="fa fa-phone"></i> 0123456789</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/flower-shop-logo-3.png" width="200px" alt=""></a>
				</div>
